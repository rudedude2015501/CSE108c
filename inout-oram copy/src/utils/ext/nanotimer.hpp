...
#if (defined(__MACH__) && defined(MACOS_USE_MACH_CLOCK))
...
#elif (defined(OE_ENCLAVE))
// https://github.com/openenclave/openenclave/blob/60dc8954833443533224262da1388e939944c3af/docs/LibcSupport.md
// ocall based time, only supports CLOCK_REALTIME
...
#elif (defined(linux) || defined(__linux__) || defined(__linux)) || (defined(__DragonFly__) || defined(__FreeBSD__) || defined(__NetBSD__) || defined(__OpenBSD__) || defined(__MACH__))
	#include <time.h>
	#include <sys/time.h>
